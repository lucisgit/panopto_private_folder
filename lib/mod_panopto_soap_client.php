...
class mod_panopto_soap_client extends SoapClient {
	var $auth_params;
	...
	public function mod_panopto_soap_client($server_name, $apiuser_userkey, $apiuser_authcode) {
	...
	private function GetPanoptoSoapVars($params) {
		...
		return array_map(array("mod_panopto_soap_client", "GetPanoptoSoapVar"),
						 array_keys($params),
						 array_values($params));
	}
